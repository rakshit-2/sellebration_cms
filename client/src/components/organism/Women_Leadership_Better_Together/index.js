...
const Women_Leadership_Better_Together=(props)=> {
    ...
    function submitPost()
    {
        ...
        Axios.post('http://localhost:5000/womenleadership/post',
        {
            name:name,
            info:info,
            img:check[1],
            checkVal:'bettertogether'
        }).then((res)=>{
            console.log(res)
            alert("Data Posted")
        });
    ...
    {
        setLoadingGet(true)
        Axios.get('http://localhost:5000/womenleadership/get',
        {
            params:{
                checkVal:'bettertogether'
            }
  ...
  return (
    ...
    <div className="page__each__outer">
        <div className="page__each__heading">
            Women Leadership Better Together
        </div>
...
export default Women_Leadership_Better_Together;