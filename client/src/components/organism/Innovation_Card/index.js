...
const Innovation_Card=(props)=> {
    ...
    function submitPost()
    {
        ...
        Axios.post('http://localhost:5000/innovation/post',
        {
            name:name,
            img:check[1],
            info:info,
    ...
    {
        setLoadingGet(true)
        Axios.get('http://localhost:5000/innovation/get',
        {
            params:{
                checkVal:'card'
            }
    ...
    <div className="page__each__outer">
        ...
        <div className='page__each__content' style={{display:display.post}}>
            <div className="name-outer">
                ...
                <input onChange={(e)=>{setNmame(e.target.value)}} type="text" placeholder={"Name"} className="name-field"  required='required'/>
            </div>
            <div className='name-outer'>
                <div className="name-label">
...
export default Innovation_Card;
