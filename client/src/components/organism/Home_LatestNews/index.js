...
const Home_LatestNews=(props)=> {
    ...
    function submitPost()
    {
        ...
        Axios.post('http://localhost:5000/home/latestnews/post',
        {
            date:date,
            info:info,
            link:link,
    ...
    {
        setLoadingGet(true)
        Axios.get('http://localhost:5000/home/latestnews/get',
        {
...
export default Home_LatestNews;