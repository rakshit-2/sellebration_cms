...
const Leadership_Director=(props)=> {
    ...
    function submitPost()
    {
        ...
        if(jobtitle=="")
        {
            alert("Fill the jobtitle correctly");
            return;
        }
  ...
  return (
    ...
    <div className="page__each__outer">
        ...
        <div className='page__each__content' style={{display:display.post}}>
            ...
            <div className='name-outer'>
                <div className="name-label">
                    Jobtitle{'\u00A0'}<i style={{color:"#EF4B4D",width:"10px",height:"10px"}} class="far fa-address-book"></i>
                </div>
                <input  onChange={(e)=>{setJobtitle(e.target.value)}} type="text" placeholder={"jobtitle"} className="name-field"  required='required'/>
            </div>
            <div className='name-outer'>
                <div className="name-label">
...
export default Leadership_Director;
